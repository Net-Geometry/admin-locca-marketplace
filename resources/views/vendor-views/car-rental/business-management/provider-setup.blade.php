                                        ...
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group mb-20">
                                                <label class="input-label font-semibold"
                                                    for="default_name">{{ translate('messages.meta_title') }}
                                                    ({{ translate('messages.Default') }})
                                                </label>
                                                <input type="text" name="name[]" id="default_name"
                                                    class="form-control"
                                                    value="{{ translate('messages.Auto Focus Car Service') }}"
                                                    placeholder="{{ translate('messages.type_meta_title') }}" required>
                                            </div>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" name="address[]" placeholder="{{ translate('messages.type_business_address') }}"
                                                    class="form-control ckeditor">Offering a delightful fusion of flavors that excite both palate and imagination. Join us for a gastronomic experience</textarea>
                                            </div>
                                        </div>
                                        @foreach (json_decode($language) as $lang)
                                            <div class="d-none lang_form" id="{{ $lang }}-form">
                                                <div class="form-group mb-20">
                                                    <label class="input-label font-semibold"
                                                        for="{{ $lang }}_name">{{ translate('messages.meta_title') }}
                                                        ({{ strtoupper($lang) }})
                                                    </label>
                                                    <input type="text" name="name[]" id="{{ $lang }}_name"
                                                        class="form-control"
                                                        placeholder="{{ translate('messages.type_meta_title') }}">
                                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="">
                                ...
                                <div class="upload-file text-wrapper">
                                    <div
                                        class="upload-file__img d-flex justify-content-center align-items-center h-180 p-0 position-relative">
                                        <input type="file" name=""
                                            class="upload-file__input single_file_input z-index-2"
                                        ...
                                        <img class="upload-file__img__img aspect-ratio-1 radius-10 border--dashed"
                                            width="180" height="180" loading="lazy" style="display: none;"
                                            src="" alt="">
    ...
    <script>
        ...
        document.querySelectorAll('.single_file_input').forEach(function(input) {
            input.addEventListener('change', function(event) {
                ...
                // Check if the image element has a valid src and show it, hiding the textbox
