                ...
                <div class="card __card mb-3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row row-margin-top">
                            ...
                            {{-- <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    <label class="input-label" for="name">{{ translate('messages.store_name') }}</label>
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    <label class="input-label" for="address">{{ translate('messages.store_address') }}</label>
                                        <textarea type="text" name="address" class="form-control __form-control"
                                        placeholder="{{ translate('messages.store_address') }}"
