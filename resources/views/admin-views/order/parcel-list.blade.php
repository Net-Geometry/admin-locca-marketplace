                        ...
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="ml-2 btn btn-sm btn--warning btn-outline-warning action-btn" href="{{route('admin.parcel.order.details',['id'=>$order['id']])}}">
            ...
            <div class="card card-lg sidebar-card sidebar-footer-fixed">
                ...
                <form class="card-body sidebar-body sidebar-scrollbar" action="{{route('admin.order.filter')}}" method="POST" id="order_filter_form">
                    ...
                    <div class="mb-2 initial--21">
                        <select name="zone[]" data-title="{{ translate('messages.select_zone') }}" data-placeholder="{{ translate('messages.select_zone') }}" id="zone_ids" class="form-control js-select2-custom" multiple="multiple">
                    ...
                    <div class="mb-2 initial--21">
                        <select name="payment_status" data-title="{{ translate('messages.payment_status') }}" data-placeholder="{{ translate('messages.payment_status') }}" class="form-control js-select2-custom" >
                            <option value="all" {{isset($payment_status) &&  $payment_status== 'all' ?'selected':''}}>{{translate('messages.All')}}</option>
                            <option value="paid" {{isset($payment_status) &&  $payment_status== 'paid' ?'selected':''}}>{{translate('messages.paid')}}</option>
                            <option value="unpaid" {{isset($payment_status) &&  $payment_status== 'unpaid' ?'selected':''}}>{{translate('messages.unpaid')}}</option>
                        </select>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="mb-2 initial--21">
                        <select name="payment_by" data-title="{{ translate('messages.payment_By') }}" data-placeholder="{{ translate('messages.payment_By') }}" class="form-control js-select2-custom" >
                            <option value="all" {{isset($payment_By) &&  $payment_By== 'all' ?'selected':''}}>{{translate('messages.All')}}</option>
                            <option value="sender" {{isset($payment_By) &&  $payment_By== 'sender' ?'selected':''}}>{{translate('messages.Sender')}}</option>
                            <option value="receiver" {{isset($payment_By) &&  $payment_By== 'receiver' ?'selected':''}}>{{translate('messages.Receiver')}}</option>
                        </select>
                    </div>
