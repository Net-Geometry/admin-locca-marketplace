                                ...
                                @foreach ($order->details as $detail)
                                    ...
                                    <tr>
                                        <td class="text-break">
                                            ...
                                            @if (is_array($variations) && isset($variations[0]) && is_array($variations[0]) && count($variations[0]) > 0)
                                                    ...
                                                    @if ($key1 != 'stock')
                                                        <div class="font-size-sm text-body">
                                                            ...
                                                            <span class="font-weight-bold">
                                                                {{ $key1 == 'price' ? \App\CentralLogics\Helpers::format_currency($variation) : $variation }}
                                                            </span>
                                                        </div>
                                                    @endif
                                                @endforeach
