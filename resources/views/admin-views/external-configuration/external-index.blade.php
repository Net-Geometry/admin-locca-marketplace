        ...
        <div class="page-header d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
            <div>
                <h1 class="page-header-title m-0">
                    <span>
                        {{translate('software_setup_and_integration')}}
                    </span>
                </h1>
                <p class="m-0">
                            ...
                            <div class="row g-4 mt-2">
                                <div class="col-md-12">
                                    ...
                                    <div class="p-3 p-sm-4 bg-soft-secondary rounded">
                                        <label class="form-label">{{ translate('messages.Software Base URL') }}
                                            <i class="tio-info-outined text-primary"
                                               title="{{translate("Get the Software’s BaseURL from the website to input here.")}}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="p-3 p-sm-4 bg-soft-secondary rounded">
                                        <label class="form-label">{{ translate('messages.Software System Token') }}
                                            <i class="tio-info-outined text-primary"
                                               title="{{translate("Copy the System Token from the software’s Setup & Integration page and paste it into this input field.")}}"
                                               data-toggle="tooltip"></i>
                                        </label>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="">
                                    ...
                                    <h5 class="mb-2">{{translate('Software Base URL Insertion')}}</h5>
                                    <p>
                                        {{translate("At first, Need to insert the Base URL of the purchased Software- Drivemond ride-sharing.")}}
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="">
                                    ...
                                    <h5 class="mb-2">{{translate('Software System Token Input')}}</h5>
                                    <p>
                                        {{translate("Visit the Drivemond")}} <a
                                            href="{{\App\CentralLogics\Helpers::get_external_data('drivemond_base_url')??"#"}}"
                                            class="text-underline text-primary">{{translate("Admin Panel")}}</a>
                                        <br>
                                        {{translate('Go to “ Business Settings → Software Setup & Integration”')}}
                                        <br>
                                        {{translate("Copy the Generated ")}}
                                        <strong>{{translate("System Token ")}}</strong>{{translate("and paste it here to the Software System Token input field.")}}
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-4">
