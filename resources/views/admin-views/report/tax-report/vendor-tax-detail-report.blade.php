                ...
                <div class="bg--secondary rounded p-20">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-15">
                        <div>
                            <h5 class="mb-1">{{ $store->name }}</h3>
                                <p class="fz-12px mb-0">{{ translate('messages.Date') }}: {{ $startDate }} - {{ $endDate }}</p>
                        </div>
                    ...
                    <div class="d-flex align-items-center gap-3 justify-content-between flex-md-nowrap flex-wrap">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            {{ translate('messages.total_order_amount') }} <span class="title-clr">{{ \App\CentralLogics\Helpers::format_currency($totalOrderAmount) }}</span>
                        </div>
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            {{ translate('messages.total_tax_amount') }} <span class="title-clr"> {{ \App\CentralLogics\Helpers::format_currency($totalTax) }}</span>
                        </div>
                    </div>
                </div>
