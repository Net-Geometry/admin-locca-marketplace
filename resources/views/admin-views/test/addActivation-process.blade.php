...
<div class="content container-fluid">
    ...
    <div class="d-content-between flex-wrap mb-20">
        <h2 class="title-clr">Add-on Activation</h2>
     ...
     <div class="d-flex flex-column gap-3">
            ...
            <div class="card-body p-20">
                <div class="row align-items-center">
                    <div class="col-xxl-8 col-md-6 mb-md-0 mb-2">
                        <h4 class="black-color mb-1 d-block">Vendor App</h4>
                        <p class="fz-12 text-c mb-1">With this app your vendor will mange their business through mobile app.</p>
                    </div>
                ...
                <form class="view-details mt-20" action=""method="POST" id="apple-login-form" enctype="">
                    <div class="bg--secondary rounded p-20 mb-20"> 
                        <div class="row g-3">
                            <div class="col-md-6 col-lg-6">
                                <div class="">
                                    <label class="mb-2 d-flex align-items-center gap-1 fz--14px">
                                        Codcanyon User Name <span class="text-danger">*</span>
                                        <i class="tio-info fz--14px secondary-clr" data-toggle="tooltip" data-bs-placement="top" title="Codcanyon User Name ...."></i>
                                    </label>
                                    <input type="text" class="form-control" name="" placeholder="Ex: Miler"value="">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <div class="">
                                    <label class="mb-2 d-flex align-items-center gap-1 fz--14px">
                                        Codcanyon Purchase Code <span class="text-danger">*</span>
                                        <i class="tio-info fz--14px secondary-clr" data-toggle="tooltip" data-bs-placement="top" title="Codcanyon Purchase Code"></i>
                                    </label>
                                    <input type="text" class="form-control" name="" placeholder="Ex: axSce1367k23"value="">
                                </div>
                            </div>
                        </div>                   
                    </div>
        ...
        <div class="card view-details-container">
            <div class="card-body p-20">
                <div class="row align-items-center">
                    <div class="col-xxl-8 col-md-6 mb-md-0 mb-2">
                        <h4 class="black-color mb-1 d-block">Deliveryman App</h4>
                        <p class="fz-12 text-c mb-1">With this app your all your deliveryman will mange their orders through mobile app.</p>
                    </div>
                    <div class="col-xxl-4 col-md-6">
                        <div class="d-flex flex-sm-nowrap flex-wrap justify-content-end justify-content-end align-items-center gap-sm-3 gap-2">
                            <div class="view-btn font-semibold order-sm-0 order-3 fz--14px text-primary cursor-pointer text-decoration-underline fw-semibold d-flex align-items-center gap-1">
                                View 
                                <i class="tio-arrow-downward"></i>
                            </div>
                            <div class="mb-0">
        ...
        <div class="card view-details-container">
            <div class="card-body p-20">
                <div class="row align-items-center">
                    <div class="col-xxl-8 col-md-6 mb-md-0 mb-2">
                        <h4 class="black-color mb-1 d-block">React User Website</h4>
                        <p class="fz-12 text-c mb-1">With this React website, your customers will experience your system in a more attractive and seamless way.</p>
                    </div>
                    <div class="col-xxl-4 col-md-6">
                        <div class="d-flex flex-sm-nowrap flex-wrap justify-content-end justify-content-end align-items-center gap-sm-3 gap-2">
                            <div class="view-btn order-sm-0 order-3 fz--14px text-primary cursor-pointer text-decoration-underline font-semibold d-flex align-items-center gap-1">
