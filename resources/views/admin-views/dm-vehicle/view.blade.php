                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="table-rest-info" href="{{route('admin.users.delivery-man.preview',[$dm['id']])}}">
                                                ...
                                                src="{{\App\CentralLogics\Helpers::get_image_helper($dm,'iamge', asset('storage/app/public/delivery-man/').'/'.$dm['image'], asset('public/assets/admin/img/160x160/img1.jpg'), 'delivery-man/') }}"
