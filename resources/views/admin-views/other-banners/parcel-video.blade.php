                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <video width="320" height="140" id="video-preview" controls>
                                                                <source src="{{($banner_video_content?->storage && $banner_video_content?->storage?->value == 's3')?$awsBaseURL.'promotional_banner/video/'.$banner_video_content?->value :asset('storage/app/public/promotional_banner/video').'/'.$banner_video_content?->value}}" type="video/{{ data_get($extention,1,'mp4') }}">
                                                            </video>
                                                        </div>
                                                        @endif
