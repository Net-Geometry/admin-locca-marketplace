...
@section('title', translate('messages.canceled_trips'))
    ...
    <div class="content container-fluid">
            ...
            <div class="d-flex justify-content-between flex-wrap gap-3">
                <div>
                    <h1 class="page-header-title text-break">
                        ...
                        <span>{{ translate('messages.canceled_trips') }}
        ...
        <div class="card">
            ...
            <div class="card-header justify-content-between gap-3 py-2 flex-wrap">
                <form class="search-form flex-grow-1 max-w-450px">
                    <!-- Search -->
                    <div class="input-group input--group">
                        <input id="datatableSearch_" type="search" value="{{ request()?->search ?? null }}"
                            name="search" class="form-control"
                            placeholder="{{ translate('Search by trip ID, customer name or Vendor name') }}"
                            aria-label="{{ translate('messages.Search by trip ID, customer name or Vendor name') }}">
