...
@section('title', translate('messages.Provider Details - Settings'))
        ...
        <div class="page-header">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs border-0 nav--tabs nav--pills mb-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-capitalize text-title active {{ request('tab') == 'settings' ? 'active' : '' }}"
                    ...
                    <div class="row g-3 align-items-end">
                            ...
                            <div class="form-group mb-0">
                                <label
                                    ...
                                    <span class="pr-1 d-flex align-items-center switch--label text--title">
                                        <span class="line--limit-1">
                                            {{ translate('messages.vendor_cancelation_rate') }}
                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('messages.vendor_cancelation_rate') }}">
                                                <i class="tio-info-outined"></i>
                                            </span>
                                        </span>
                                    </span>
                                    <input type="checkbox" data-id="vendor_cancelation_rate_status" data-type="toggle"
                                        data-image-on="{{ asset('/public/assets/admin/img/modal/dm-tips-on.png') }}"
                                        data-image-off="{{ asset('/public/assets/admin/img/modal/dm-tips-off.png') }}"
                                        data-title-on="<strong>{{ translate('messages.vendor_cancelation_rate?') }}</strong>"
                                        data-title-off="<strong>{{ translate('messages.vendor_cancelation_rate?') }}</strong>"
                                        data-text-on="<p>{{ translate('messages.If_you_enable_this,vendor_cancelation_rate_will_be_enabled.') }}</p>"
                                        data-text-off="<p>{{ translate('messages.If_you_disable_this,vendor_cancelation_rate_will_be_disabled.') }}</p>"
                                        class="status toggle-switch-input dynamic-checkbox-toggle" value="1"
                                        name="vendor_cancelation_rate_status" id="vendor_cancelation_rate_status"
                                        checked>
                                    <span class="toggle-switch-label text">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                        ...
                        <div class="col-md-12">
                            <div class="btn--container justify-content-end mt-3">
                                ...
                                <button type="submit"
                                    class="btn btn--primary min-w-120px">{{ translate('messages.save_changes') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    ...
                    <p class="fs-12 mb-0">
                        {{ translate('messages.Vendor Logo & Covers') }}
                    </p>
                </div>
            </div>
