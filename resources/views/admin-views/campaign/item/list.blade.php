                    ...
                    <table id="columnSearchDatatable"
                        ...
                        @foreach($campaigns as $key=>$campaign)
                            <tr>
                                ...
                                <td>
                                    <span class="bg-gradient-light text-dark">{{$campaign->start_date? \App\CentralLogics\Helpers::date_format($campaign?->start_time).'-'.  \App\CentralLogics\Helpers::date_format($campaign?->end_date): 'N/A'}}</span>
                                </td>
                                <td>
