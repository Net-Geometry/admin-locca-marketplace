            ...
            <div class="row g-3">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header card-header-shadow">
                            <h5 class="card-title d-flex align-items-center">
                                <img src="{{asset('/public/assets/admin/img/ic_round-campaign.png')}}" alt="" class="card-header-icon align-self-center mr-1">
                                <span>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="form-group mb-0">
                                            <label class="input-label"
                                                for="loyalty_point_exchange_rate">1 {{ \App\CentralLogics\Helpers::currency_code() }} {{ translate('equivalent point amount') }}</label>
                                ...
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-4">
                                        <div class="text-left">
                                            ...
                                            <h4 class="align-items-center">
                                                <img src="{{asset('/public/assets/admin/img/Who_Use_the_code.png')}}" alt="" class="card-header-icon align-self-center mr-1">
                                                <span>
                                    ...
                                    <div class="card-body">
                                        <div>
                                            <div class="form-group mb-0">
                                                <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control">
                                                    <span class="pr-2">{{ translate('Customer_will_get_Discount_on_first_order ') }}
                                                        <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('messages.Configure_discounts_for_newly_registered_users_who_sign_up_with_a_referral_code._Customize_the_discount_type_and_amount_to_incentivize_referrals_and_encourage_user_engagement.') }}">
                                                            <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.show_hide_food_menu') }}">
                                                        </span>
                                                    </span>
                                                    <input type="checkbox"
