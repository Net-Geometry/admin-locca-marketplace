...
<table class="email-template-table-style">
    ...
    <tr>
        <td class="email-template-table-td-style-2">
            ...
            <img class="email-template-img" onerror="this.src='{{ asset('storage/app/public/business/' . $store_logo) }}'" src="{{ asset('storage/app/public/email_template/') }}/{{ $data['logo']??'' }}" alt="public/img">
