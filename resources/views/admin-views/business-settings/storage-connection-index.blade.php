    ...
    <div class="content container-fluid">
        ...
        <div class="card mt-3">
            <div class="p-4 card-header-shadow">
                ...
                <span>{{ translate('The_Access_Key_ID_is_a_publicly_accessible_identifier_used_to_authenticate_requests_to_S3.') }} <a target="_blank" href="https://laravel-news.com/using-aws-s3-for-laravel-storage">{{ translate('Learn_More') }}</a></span>            </div>
            <div class="card-body">
                <div class="mt-2 px-3">
                    <form
