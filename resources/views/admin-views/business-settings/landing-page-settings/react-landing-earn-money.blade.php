...
@section('content')
    <div class="content container-fluid">
        ...
        @php($join_seller_react_status = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'join_seller_react_status')->first()?->value)
        @php($join_DM_react_status = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'join_DM_react_status')->first()?->value)
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'earning-seller-link') }}" method="post" id="join_seller_react_status_form">
                    @csrf
                        ...
                        <div class="card-header">
                            ...
                            <label class="toggle-switch justify-content-end  rounded">
                                <input type="checkbox" data-id="join_seller_react_status" data-type="status"
                                    ...
                                    name="" id="join_seller_react_status"
                                    {{ $join_seller_react_status == 1 ? 'checked' : '' }}>
                            ...
                            <div class="row g-3">
                                    ...
                                    @if ($language)
                                        <div class="row g-3 lang_form default-form">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input id="earning_seller_sub_title" type="text" maxlength="65"
                                            ...
                                            <div class="row g-3 d-none lang_form" id="{{ $lang }}-form1">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="earning_seller_title{{ $lang }}" type="text"
                                                        maxlength="30" name="earning_seller_title[]" class="form-control"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="earning_seller_sub_title{{ $lang }}"
                                                        type="text" maxlength="65" name="earning_seller_sub_title[]"
                                                        class="form-control"
                                                        value="{{ $earning_seller_sub_title_translate[$lang]['value'] ?? '' }}"
                                                        placeholder="{{ translate('messages.sub_title_here...') }}">
                                                </div>
                                            </div>
                                            <input type="hidden" name="lang[]" value="{{ $lang }}">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h5 class="card-title">
                                            <img src="{{ asset('public/assets/admin/img/btn-cont.png') }}" class="mr-2"
                                                alt="">
                                                ...
                                                @if ($language)
                                                    <div class="form-group lang_form default-form">
                                                        ...
                                                        <input id="earning_seller_button_name" type="text"
                                                            maxlength="20" name="earning_seller_button_name[]"
                ...
                <form action="{{ route('admin.business-settings.react-landing-page-settings', 'earning-dm-link') }}" method="post" id="join_DM_react_status_form">
                    @csrf
                        ...
                        <div class="card-header">
                            ...
                            <label class="toggle-switch justify-content-end  rounded">
                                <input type="checkbox" data-id="join_DM_react_status" data-type="status"
                                    ...
                                    class="status toggle-switch-input dynamic-checkbox" value="1"
                                    name="" id="join_DM_react_status"
                                    {{ $join_DM_react_status == 1 ? 'checked' : '' }}>
                                <span class="toggle-switch-label text">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                        ...
                        <div class="card-body {{ $join_DM_react_status != 1 ? 'd-none' : '' }}">
                            ...
                            <div class="row g-3">
                                    ...
                                    @if ($language)
                                        <div class="row g-3 lang_form default-form">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input id="earning_dm_sub_title" type="text" maxlength="65"
                                        ...
                                        @foreach (json_decode($language) as $lang)
                                            ...
                                            <div class="row g-3 d-none lang_form" id="{{ $lang }}-form3">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="earning_dm_sub_title{{ $lang }}" type="text"
                                                        maxlength="65" name="earning_dm_sub_title[]" class="form-control"
                                                        value="{{ $earning_dm_sub_title_translate[$lang]['value'] ?? '' }}"
                                                        placeholder="{{ translate('messages.sub_title_here...') }}">
                                                </div>
                                            </div>
                                            <input type="hidden" name="lang[]" value="{{ $lang }}">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h5 class="card-title">
                                            <img src="{{ asset('public/assets/admin/img/btn-cont.png') }}"
                                                class="mr-2" alt="">
                                            {{ translate('Button Content') }}
                                        </h5>
                                    </div>
                                    <div class="__bg-F8F9FC-card">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                @if ($language)
                                                    <div class="form-group lang_form default-form">
                                                        <label for="earning_dm_button_name"
                                                            class="form-label text-capitalize">
                                                            {{ translate('Button Name') }}({{ translate('messages.default') }})
                                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                                data-placement="right"
                                                    ...
                                                    @foreach (json_decode($language) as $lang)
                                                        ...
                                                        <div class="form-group d-none lang_form"
                                                            ...
                                                            <input id="earning_dm_button_name{{ $lang }}"
                                                                type="text" maxlength="20"
                                                                name="earning_dm_button_name[]"
