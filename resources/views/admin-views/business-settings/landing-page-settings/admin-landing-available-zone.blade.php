    ...
    <form id="zone-setup-form" action="{{ route('admin.business-settings.admin-landing-page-settings', 'available-zone-section') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-sm-6">
                        {{ translate('To view a list of all active zomes on your') }} <a href="{{route('home')}}" target="_blank" class="text-primary">{{ translate('Admin Landing') }}</a> {{ translate('Page,') }} <br class="d-none d-md-inline-block"> {{ translate('Enable the `Available Zones` feature') }}
                    </div>
                    <div class="col-sm-6">
                        <label
                            ...
                            <input type="checkbox"
                                   ...
                                   data-text-on="<p>{{ translate('messages.If_you_enable_this,_only_available_zone_will_be_visible.') }}</p>"
                                   data-text-off="<p>{{ translate('messages.If_you_disable_this,_all_zone_will_not_be_visible.') }}</p>"
