<?php return array (
  ...
  'By_name_or_phone' => 'By name or phone',
  ...
  'Step 2' => 'Step 2',
  'Once_you_have_downloaded_and_filled_the_format_file_upload_it_in_the_form_below_and_submit' => 'Once you have downloaded and filled the format file upload it in the form below and submit',
  ...
  'You_can_edit_and_update_the_file_to_bulk_upload' => 'You can edit and update the file to bulk upload',
  'You_can_download_it_to_excel_file' => 'You can download it to excel file',
  '3. Once you have downloaded and filled the format file, upload it in the form below and submit.Make sure the phone numbers and email addresses are unique.' => '3. Once you have downloaded and filled the format file  upload it in the form below and submit.Make sure the phone numbers and email addresses are unique.',
  ...
  'Once_you_have_downloaded_and_filled_the_format_file,_upload_it_in_the_form_below_and_submit.Make_sure_the_phone_numbers_and_email_addresses_are_unique' => 'Once you have downloaded and filled the format file  upload it in the form below and submit.Make sure the phone numbers and email addresses are unique',
  'You can get module id and  zone id from their list, please input the right ids.' => 'You can get module id and  zone id from their list  please input the right ids.',
  'For delivery time the format is "from-to type" for example: "30-40 min". Also you can use days or hours as type. Please be carefull about this format or leave this field empty.' => 'For delivery time the format is  from-to type  for example:  30-40 min . Also you can use days or hours as type. Please be carefull about this format or leave this field empty.',
