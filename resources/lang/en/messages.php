...
Smartly or Earn. ',
  ...
  'Verify External Link' => 'Verify External Link',
  'Type Your Identity Number' => 'Type Your Identity Number',
  'Verify' => 'Verify',
  'Nadi Verification' => 'Nadi Verification',
  'Nadi Number' => 'Nadi Number',
  'Enter Nadi Number' => 'Enter Nadi Number',
  'Nadi Member Verification' => 'Nadi Member Verification',
  'Enter Nadi member number' => 'Enter Nadi member number',
  'Please enter a member number.' => 'Please enter a member number.',
  'Member verified successfully!' => 'Member verified successfully!',
  'Verification failed. Please check the number and try again.' => 'Verification failed. Please check the number and try again.',
  'An unexpected error occurred.' => 'An unexpected error occurred.',
  'An error occurred while verifying.' => 'An error occurred while verifying.',
  ...
  'Nadi Configuration' => 'Nadi Configuration',
  'Nadi Status' => 'Nadi Status',
  'Nadi API Key' => 'Nadi API Key',
  'Nadi Endpoint URL' => 'Nadi Endpoint URL',
  'nadi_configuration' => 'Nadi configuration',
