...
class OrderController extends Controller
{
    ...
    $digital_payment = Helpers::get_business_settings('digital_payment');
        ...
        $order->extra_packaging_amount =  (($extra_packaging_data[$store->module->module_type]=='1') && ($store?->storeConfig?->extra_packaging_status == '1'))?$store?->storeConfig?->extra_packaging_amount:0;
