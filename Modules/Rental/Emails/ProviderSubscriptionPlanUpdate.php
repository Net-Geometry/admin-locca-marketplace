...
class ProviderSubscriptionPlanUpdate extends Mailable
{
    ...
    public function build()
    {
        ...
        $data=RentalEmailTemplate::where('type','provider')->where('email_type', 'subscription-plan_upadte')->first();
        ...
        return $this->subject(translate('Subscription_Plan_Updates'))->view('rental::email-templates.new-email-format-'.$template, ['company_name'=>$company_name,'data'=>$data,'title'=>$title,'body'=>$body,'footer_text'=>$footer_text,'copyright_text'=>$copyright_text,'url'=>$url]);
    }
}
