                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="border resturant-type-group">
                                            <label class="align-items-center d-flex form-check item">
                                                <input class="form-check-input single-select" type="checkbox" name="trip_type"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0 pickup-zone-tag">
                                <select name="tag[]" id="pickup_zones"
                                        class="form-control js-select2-custom select2-hidden-accessible" multiple="multiple">
                                    <option value="1" selected disabled>{{ translate('messages.New_York_State') }}
                                    </option>
                                </select>
                            </div>
                        </div>
