    ...
    $.fn.spartanMultiImagePicker = function (options) {
        ...
        function addRow(settings, el) {
            ...
            var template =
                ...
                `<div style="position: absolute !important; right : 15px; top: 15px;display:flex; gap:8px"><a href="javascript:void(0)" data-spartanindexremove="${count}" style="display : none; background : transparent; border-radius: 3px; width: 25px; height: 25px; line-height : 22px; text-align: center; text-decoration : none; color : #ff0700;border:1px solid #ff0700"><i class="tio-add-to-trash"></i></a>
                <div style="background : transparent; border-radius: 3px; width: 25px; height: 25px; line-height : 22px; text-align: center; text-decoration : none; color : #4153B3;border:1px solid #4153B3"><i class="tio-edit"></i></div></div>` +
